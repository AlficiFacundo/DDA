...
HD_PWD='C:/Users/facun/vivadoProjects/GP2_ej1/GP2_ej1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mult.tcl -notrace
