...
HD_PWD='C:/Users/facun/vivadoProjects/GP2_ej1/GP2_ej1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mult.tcl
